  ...
  const submitCallBack = (e) => {
    ...
    if (!validator.isEmpty(admin.username) && validator.isEmail(admin.email)) {
      if (validator.isEmpty(admin.phone)) {
        ...
        for (const key in admin) formData.append(key, admin[key]);
                  ...
                  <Card className="">
                    <Card.Body>
                      <Form onSubmit={(e) => submitPic(e)}>
                        ...
                        <div className="user-profile-img position-relative m-auto">
                          <img
                            alt="..."
                            className="avatar border-gray"
                            src={
                              admin.profileImage
                                ? admin.profileImage.includes("data:image")
                                  ? admin.profileImage
                                  : `${ENV.Backend_Img_Url}${admin.profileImage}`
                                : userDefaultImg
                            }
                          ></img>
                          <label className="upload-button display-inline-block p-2">
                    ...
                    <Card className="pb-4">
                      <Card.Header>
                        <Card.Header className="pl-0">
                          <Card.Title as="h4" className="yellow-color">
                            Profile Management
                          </Card.Title>
                        </Card.Header>
                      </Card.Header>
