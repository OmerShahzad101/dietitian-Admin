...
const Services = (props) => {
    ...
    useEffect(() => {
        if (props.services.servicesListAuth) {
            const { servicesList, pagination } = props.services
            setServicesData(servicesList)
            setPagination(pagination)
        }
    }, [props.services.servicesListAuth, props.services.servicesList])
                                            ...
                                            <Table className="table-striped w-full">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        {userAuthenticData?.permissionId?.servicesEdit||userAuthenticData?.permissionId?.servicesDelete?<th className="td-actions">Action</th>:""}
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                {
                                                        ...
                                                        return (
                                                            <tr key={index}>
                                                                ...
                                                                <td className="td-actions">
                                                                    {
                                                                        userAuthenticData?.permissionId?.servicesEdit ? 
                                                                        <OverlayTrigger
                                                                        overlay={
                                                                        ...
                                                                        <Button
                                                                            ...
                                                                            type="button"
                                                                            variant="warning"
                                                                            onClick={() => history.push(`/services/edit/${data._id}`)}>
                                                                            <i className="fas fa-edit"></i>
                                                                        </Button>
                                                                        </OverlayTrigger> : ""}
                                                                       {
                                                                           userAuthenticData?.permissionId?.servicesDelete ? 
                                                                           <OverlayTrigger
                                                                            overlay={
...

            {
                delModalCheck && <Modal show={delModalCheck} onHide={() => setDelModalCheck(false)}>
                    ...
                    <Modal.Footer className='d-flex justify-content-center'>
                        ...
                        <Button variant="primary" onClick={delService} className="yellow-bg save-btn">
                            Yes
                        </Button>
                    </Modal.Footer>
                    </Modal>
...
export default connect(mapStateToProps, { listServices, deleteService })(Services)