  ...
  var routesArr = [
    ...
    // },
    {
      ...
      submenus: [
        ...
        // },
        {
          path: "/dietitianmembership",
          layout: Admin,
          mini: "SS",
          name: "Dietitian Memberships",
        ...
        // },
        {
          path: "/dietitianrecord",
          layout: Admin,
          mini: "SS",
          name: "Dietitian Membership Data",
    ...
    {
      exceptional:true,
      path: "/dietitianmembership/create",
      layout: Admin,
    ...
    {
      exceptional:true,
      path: "/dietitianmembership/edit/:id",
      layout: Admin,
    ...
    {
      exceptional:true,
      path: "/dietitianmembership/view/:id",
      layout: Admin,
